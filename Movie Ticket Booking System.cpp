...
public:
    ...
    void hal_name()
    {
        ...
        {
            case 1:
            hall_name="INOX RAJSHAHI";
            break;
             case 2:
            hall_name="CINEPOLIS RAJSHAHI";
            break;
             case 3:
            hall_name="RAJSHAHI MOVIES";
            break;
             case 4:
            hall_name="RAJSHAHI CINEPLEX";
            break;
        }
...
fin.open("movie_test2.csv");
   ...
   getline(fin,name[i],',');
   cout<<"\n\n\t\t\t\t\t\t\tTHIS IS THE SEAT FOR MOVIE: "<<name[i]<<"\n\n";
    fin.close();
    for(i=0;i<13;i++)
    {
        ch='A';
...
int main()
{
    ...
    while(1)
    {
        cout<<"\n\n\t\t\t\t\t\t\t PRESS 1 TO BOOK TICKET IN INOX RAJSHAHI";
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 2 TO BOOK TICKET IN CINEPOLIS RAJSHAHI";
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 3 TO BOOK TICKET IN RAJSHAHI MOVIES";
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 4 TO BOOK TICKET IN RAJSHAHI CINEPLEX";
    ...
    switch(obn)
    {
        case 1:
            cout<<"\t\t\t\t\t\t\t";
            cout<<"INOX RAJSHAHI IS SELECTED\n";
        obj[0].first();
        break;
        case 2:
        cout<<"\t\t\t\t\t\t\t";
            cout<<"CINEPOLIS RAJSHAHI IS SELECTED\n";
        obj[1].first();
        break;
        case 3:
        cout<<"\t\t\t\t\t\t\t";
             cout<<"RAJSHAHI MOVIES IS SELECTED\n";
        obj[2].first();
        break;
        case 4:
        cout<<"\t\t\t\t\t\t\t";
            cout<<"RAJSHAHI CINEPLEX IS SELECTED\n";
        obj[3].first();
        break;
        case 9:
                goto bye;
